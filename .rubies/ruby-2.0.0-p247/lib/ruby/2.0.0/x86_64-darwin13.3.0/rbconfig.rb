...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.0.0/x86_64-darwin13.3.0")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/vray/.rubies/ruby-2.0.0-p247")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/vray/.rubies/ruby-2.0.0-p247' '--with-openssl-dir=/usr/local/opt/openssl' '--with-readline-dir=/usr/local/opt/readline' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/vray/.rubies/ruby-2.0.0-p247/lib ' 'CPPFLAGS=-I/Users/vray/.rubies/ruby-2.0.0-p247/include '"
  ...
  CONFIG["arch"] = "x86_64-darwin13.3.0"
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/vray/.rubies/ruby-2.0.0-p247/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/vray/.rubies/ruby-2.0.0-p247/lib  -fstack-protector -L/usr/local/lib"
  ...
  CONFIG["target"] = "x86_64-apple-darwin13.3.0"
